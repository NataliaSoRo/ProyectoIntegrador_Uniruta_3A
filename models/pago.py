class Pago:
    def __init__(self, id=None, id_viaje=None, id_chofer=None, pago_base=None, pago_inicial=None, pago_final=None, total_acumulado=None,  metodo_pago=None, periodo_pago=None):
        self.id=id
